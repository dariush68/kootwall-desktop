...
Rectangle{
    ...
    onSetedIndex:{
        ...
        if(categoryID === "empty"){
            ...
            txf_categories_material.text = parentCatId
            fetchBasedonSubMaterial(categoryID)
    ...
    signal returnSelectedSubMaterial(string subMaterialID)
    ...
    property string pageTitle:              "بخش 3"  //-- modul header title --//
    ...
    property bool isMaterialShow    : false
                    ...
                    delegate: ItemDelegate{
                        ...
                        onClicked: {
                            ...
                            //-- normal mode --//
                                ...
                                txf_categories_material.text        = listmodel.get(lv.currentIndex).material
...
//                        setedIndex(parseInt(txf_categories_categoryID.text))
                        returnSelectedSubMaterial(txf_categories_categoryID.text)

                        //-- set collapse label text to current Item --//
                        lbl1.text = ""
                              + (isIdShow           ? txf_categories_categoryID.text            : "")
                              + (isMaterialShow     ? "  " + txf_categories_material.text   : "")
                        ...
                        GridLayout{
                            ...
                            SearchField{
                                ...
                                onAcceptedText: {
                                    ...
                                    var endpoint = "api/kootwall/SubMaterial?q=" + text
                                    ...
                                    Service.get_all( endpoint, function(resp, http) {
                                        ...
                                        returnSelectedSubMaterial(listmodel.get(lv.currentIndex).id)
                        ...
                        onClicked: {
                            if(btnReorder.state === "WAIT"){
                                ...
                                if(btnReorder.isDirty){
                                    ...
                                    var endpoint = "api/kootwall/SubMaterial?c=" + parentCatId + "&list=" + list
                                    ...
                                    Service.get_all( endpoint, function(resp, http) {
                                        ...
                                        if(listmodel.count > 0){
                                            ...
                                            returnSelectedSubMaterial("empty")
                                        }
...
//                            log("num = " + num + ", len = " + len + " => res = " + res)
                    ...
                    MButton{
                        ...
                        onClicked: {
                            ...
                            if(txf_categories_material.text === ""){
                                log("parent ID is empty")
                                message.text = "parent ID is empty"
                                triggerMsg("در شاخه زیرمجموعه 1 آیتمی انتخاب نشده است", "RED")
                                return
                            }
                            ...
                            var data = {
                                ...
                                "material"  : txf_categories_material.text,
//                                "pic"       : txf_categories_pic.text,
                            ...
                            checkToken(function(resp){
                                ...
                                Service.create_item(_token_access, endpoint, data, function(resp, http) {
                                    ...
                                    //-- log activity --//
                                    logActivity(_ACTIVITY_CREATE, _SUBMATERIAL, ("عنوانی جدید در بخش 3 ایجاد شد: " + txf_categories_title.text))
...
//                                    "pic"       : txf_categories_pic.text
                                ...
                                checkToken(function(resp){
                                    ...
                                    var endpoint = "api/kootwall/SubMaterial/" + listmodel.get(clickedIndex).id + "/"
                                    ...
                                    Service.update_item(_token_access, endpoint, data, function(resp, http) {
                                        ...
                                        //-- log activity --//
                                        logActivity(_ACTIVITY_UPDATE, _SUBMATERIAL, ("به روز رسانی عنوان در بخش 3: " + txf_categories_title.text))
                                    ...
                                    Service.delete_item(_token_access, endpoint, function(resp, http) {
                                        ...
                                        if(resp.hasOwnProperty('del')) // chack exist detail in resp
                                        {
                                            if(resp.del.indexOf("successfull delete operation") > -1){
                                                ...
                                                //-- log activity --//
                                                logActivity(_ACTIVITY_DELETE, _SUBMATERIAL, ("حذف عنوان در بخش 3: " + txf_categories_title.text))

                                                listmodel.remove(clickedIndex, 1)

                                                //-- triger subcategory list --//
                                                if(lv.count>0)
                                                    returnSelectedSubMaterial(listmodel.get(clickedIndex).id)
                                                else returnSelectedSubMaterial("empty")
                    ...
                    ColumnLayout{
                        ...
                        Rectangle{
                            ...
                            Label{
                                ...
                                /*text: ""
                                      + (isIdShow           ? txf_categories_categoryID.text            : "")
                                      + (isMaterialCategoryShow ? "  " + txf_categories_material.text   : "")
                                      + (isTitleShow        ? "  " + txf_categories_title.text          : "")
                                      + (isPicShow          ? "  " + txf_categories_pic.text            : "")
                                      + (isDateShow         ? "  " + txf_categories_date.text           : "")*/
                                rotation: 90
    ...
    function fetchBasedonSubMaterial(categoryID){
        ...
        //-- search based on categoryID --//
        var endpoint = "api/kootwall/SubMaterial?c=" + categoryID
    ...
    function clearCategoriesTextfields(){
        ...
        if(isMaterialShow   && txf_categories_material.enabled)     txf_categories_material.text    = ""
    }
