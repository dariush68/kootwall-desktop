...
Rectangle{
    ...
    onSetedIndex:{
        ...
        log("recived categoryID in MC = " + categoryID)
        ...
        if(categoryID === "empty"){
            ...
            returnSelectedMaterialCategory("empty")
            ...
            txf_categories_baseCategory.text    = ""
        }
        else{
            ...
            txf_categories_baseCategory.text = parentCatId
            fetchBasedonBaseCategory(categoryID)
        }
    ...
    signal returnSelectedMaterialCategory(string materialCategoryID)
    ...
    function selectNewItemBasedonID(catID, cb){
        ...
        for(var i=0; i< listmodel.count && !flagFound; i++){
            ...
            if(catID === listmodel.get(i).id.toString()){
                ...
                lv_materialCategories.currentIndex = i
                flagFound = true
                log("founded, index = " + i)
            }
        }
    ...
    property string pageTitle:              "بخش 1" //-- modul header title --//
    ...
    property alias  selModelIndx:           lv_materialCategories.currentIndex //-- listview current index --//

    //-- handle Expand mode status --//
    onIsExpandChanged: {

        log("lv_materialCategories.currentIndex = " + lv_materialCategories.currentIndex)
        log("lv_materialCategories.count = " + lv_materialCategories.count)
        //-- check current index of list view --//
        if(lv_materialCategories.count > 0 /*&& lv_materialCategories.currentIndex < 0*/){

            var temp = lv_materialCategories.currentIndex
            lv_materialCategories.currentIndex = -1
            lv_materialCategories.currentIndex = temp
    ...
    property bool isBaseCategoryShow: false
            ...
            Item {
                ...
                ListView{
                    ...
                    ScrollBar.vertical: ScrollBar {
                        ...
                        policy: listmodel.count>(lv_materialCategories.height/40) ? ScrollBar.AlwaysOn : ScrollBar.AlwaysOff
                    ...
                    delegate: ItemDelegate{
                        ...
                        onClicked: {
                            ...
                            //-- normal mode --//
                                ...
                                lv_materialCategories.currentIndex = index

                                txf_categories_categoryID.text      = listmodel.get(lv_materialCategories.currentIndex).id
                                txf_categories_baseCategory.text    = listmodel.get(lv_materialCategories.currentIndex).baseCategory
                                txf_categories_title.text           = listmodel.get(lv_materialCategories.currentIndex).title
                                txf_categories_pic.text             = ""//listmodel.get(lv_materialCategories.currentIndex).pic
                                txf_categories_date.text            = listmodel.get(lv_materialCategories.currentIndex).date
                            }
                        }
                    ...
                    onCurrentIndexChanged:{
                        ...
                        if(lv_materialCategories.count < 1) return

                        //-- controll currentIndex of listview --//
                        if(lv_materialCategories.currentIndex < 0) return
                        ...
                        returnSelectedMaterialCategory(txf_categories_categoryID.text)

                        //-- set collapse label text to current Item --//
                        lbl1.text = ""
                                + (isIdShow           ? txf_categories_categoryID.text            : "")
                                + (isBaseCategoryShow ? "  " + txf_categories_baseCategory.text   : "")
                    ...
                    add: Transition {
                        ...
                        NumberAnimation {
                            properties: "x"; from: -lv_materialCategories.width;
                            duration: 250;
                        }
                    }
                    remove: Transition {
                        ...
                        NumberAnimation {
                            properties: "x"; to: lv_materialCategories.width;
                            duration: 250;
                        }
                    }
                        ...
                        GridLayout{
                            ...
                            SearchField{
                                ...
                                onAcceptedText: {
                                    ...
                                    var endpoint = "api/kootwall/MaterialCategory?q=" + text
                                    ...
                                    Service.get_all( endpoint, function(resp, http) {
                                        ...
                                        returnSelectedMaterialCategory(listmodel.get(lv_materialCategories.currentIndex).id)
                            ...
                            TextField{
                                id: txf_categories_baseCategory
                                visible: isBaseCategoryShow
                                Layout.row: 2
                                Layout.column: 1
                        ...
                        onClicked: {
                            if(btnReorder.state === "WAIT"){
                                ...
                                if(btnReorder.isDirty){
                                    ...
                                    var endpoint = "api/kootwall/MaterialCategory?c=" + parentCatId + "&list=" + list
                                    ...
                                    Service.get_all( endpoint, function(resp, http) {
                                        ...
                                        if(listmodel.count > 0){
                                            ...
                                            lv_materialCategories.currentIndex = -1 //-- trigger current index --//
                                            lv_materialCategories.currentIndex = 0
                                            returnSelectedMaterialCategory(listmodel.get(lv_materialCategories.currentIndex).id)
                                            log("--- FILL ----")
...
//                            log("num = " + num + ", len = " + len + " => res = " + res)
                    ...
                    MButton{
                        ...
                        onClicked: {
                            ...
                            if(txf_categories_baseCategory.text === ""){
                                log("parent ID is empty")
                                message.text = "parent ID is empty"
                                triggerMsg("در شاخه زیردسته بندی آیتمی انتخاب نشده است", "RED")
                                return
                            }
                            ...
                            var data = {
                                ...
                                "baseCategory"  : txf_categories_baseCategory.text,
//                                "pic"           : txf_categories_pic.text,
                            ...
                            checkToken(function(resp){
                                ...
                                Service.create_item(_token_access, endpoint, data, function(resp, http) {
                                    ...
                                    listmodel.setProperty(lv_materialCategories.count-1, "isSelected", false)
                                    lv_materialCategories.currentIndex = lv_materialCategories.count-1
                                    message.text = "Item created"
                                    triggerMsg("عنوان جدید ایجاد شد", "LOG")

                                    //-- log activity --//
                                    logActivity(_ACTIVITY_CREATE, _CATEGORYMATERIAL, ("عنوانی جدید در بخش 1 ایجاد شد: " + txf_categories_title.text))
                    ...
                    MButton{
                        ...
                        onClicked: {
                            ...
                            if(txf_categories_title.text === listmodel.get(lv_materialCategories.currentIndex).title){
...
//                                    "pic"           : txf_categories_pic.text
                                ...
                                var clickedIndex = lv_materialCategories.currentIndex
                                ...
                                checkToken(function(resp){
                                    ...
                                    var endpoint = "api/kootwall/MaterialCategory/" + listmodel.get(clickedIndex).id + "/"
                                    ...
                                    Service.update_item(_token_access, endpoint, data, function(resp, http) {
                                        ...
                                        //-- log activity --//
                                        logActivity(_ACTIVITY_UPDATE, _CATEGORYMATERIAL, ("به روز رسانی عنوان در بخش 1: " + txf_categories_title.text))
                                    ...
                                    Service.delete_item(_token_access, endpoint, function(resp, http) {
                                        ...
                                        if(resp.hasOwnProperty('del')) // chack exist detail in resp
                                        {
                                            if(resp.del.indexOf("successfull delete operation") > -1){
                                                ...
                                                //-- log activity --//
                                                logActivity(_ACTIVITY_DELETE, _CATEGORYMATERIAL, ("حذف عنوان در بخش 1: " + txf_categories_title.text))

                                                listmodel.remove(clickedIndex, 1)

                                                //-- triger subcategory list --//
                                                if(lv_materialCategories.count>0)
                                                    returnSelectedMaterialCategory(listmodel.get(clickedIndex).id)
                                                else returnSelectedMaterialCategory("empty")
    ...
    //-- fetch data based on BaseCategoryId --//
    function fetchBasedonBaseCategory(categoryID){
        ...
        //-- search based on categoryID --//
        var endpoint = "api/kootwall/MaterialCategory?c=" + categoryID
    ...
    function clearCategoriesTextfields(){
        ...
        if(isBaseCategoryShow   && txf_categories_baseCategory.enabled)     txf_categories_baseCategory.text    = ""
    }
