...
Rectangle{
    ...
    onSetedIndex:{
        ...
        if(categoryID === "empty"){
            ...
            txf_categories_subMaterial.text = parentCatId
            fetchBasedonSubSubMaterial(categoryID)
    ...
    signal returnSelectedSubSubMaterial(string subSubMaterialID)
    ...
    property string pageTitle:              "بخش 4"  //-- modul header title --//
    property bool   isExpand:               false           //-- keep Expand mode status --//
    ...
    property alias  modelItm:               listmodel       //-- category ListModel --//
    ...
    property bool isSubMaterialShow : false
                    ...
                    delegate: ItemDelegate{
                        ...
                        onClicked: {
                            ...
                            //-- normal mode --//
                                ...
                                txf_categories_subMaterial.text     = listmodel.get(lv.currentIndex).subMaterial
...
//                        setedIndex(parseInt(txf_categories_categoryID.text))
                        ...
                        lbl1.text = ""
                              ...
                              + (isSubMaterialShow      ? "  " + txf_categories_subMaterial.text   : "")
                        ...
                        GridLayout{
                            ...
                            SearchField{
                                ...
                                onAcceptedText: {
                                    ...
                                    var endpoint = "api/kootwall/SubSubMaterial?q=" + text
                                    ...
                                    Service.get_all( endpoint, function(resp, http) {
                                        ...
                                        returnSelectedSubSubMaterial(listmodel.get(lv.currentIndex).id)
                            ...
                            TextField{
                                id: txf_categories_subMaterial
                                visible: isSubMaterialShow
                                Layout.row: 2
                                Layout.column: 1

                                placeholderText: "دسته والد"
                                selectByMouse: true
                                enabled: false
                            }
                        ...
                        onClicked: {
                            if(btnReorder.state === "WAIT"){
                                ...
                                if(btnReorder.isDirty){
                                    ...
                                    var endpoint = "api/kootwall/SubSubMaterial?c=" + parentCatId + "&list=" + list
...
//                            log("num = " + num + ", len = " + len + " => res = " + res)
                    ...
                    MButton{
                        ...
                        onClicked: {
                            ...
                            var endpoint = "api/kootwall/SubSubMaterial"
                    ...
                    MButton{
                        ...
                        onClicked: {
                            ...
                            if(txf_categories_subMaterial.text === ""){
                                log("parent ID is empty")
                                message.text = "parent ID is empty"
                                triggerMsg("در شاخه زیرمجموعه 2 آیتمی انتخاب نشده است", "RED")
                                return
                            }
                            ...
                            var data = {
                                ...
                                "subMaterial"   : txf_categories_subMaterial.text,
//                                "pic"           : txf_categories_pic.text,
                            ...
                            checkToken(function(resp){
                                ...
                                Service.create_item(_token_access, endpoint, data, function(resp, http) {
                                    ...
                                    //-- log activity --//
                                    logActivity(_ACTIVITY_CREATE, _SUBSUBMATERIAL, ("عنوانی جدید در بخش 4 ایجاد شد: " + txf_categories_title.text))
...
//                                    "pic"           : txf_categories_pic.text
                                ...
                                checkToken(function(resp){
                                    ...
                                    var endpoint = "api/kootwall/SubSubMaterial/" + listmodel.get(clickedIndex).id + "/"
                                    ...
                                    Service.update_item(_token_access, endpoint, data, function(resp, http) {
                                        ...
                                        //-- log activity --//
                                        logActivity(_ACTIVITY_UPDATE, _SUBSUBMATERIAL, ("به روز رسانی عنوان در بخش 4: " + txf_categories_title.text))
                                    ...
                                    Service.delete_item(_token_access, endpoint, function(resp, http) {
                                        ...
                                        if(resp.hasOwnProperty('del')) // chack exist detail in resp
                                        {
                                            if(resp.del.indexOf("successfull delete operation") > -1){
                                                ...
                                                //-- log activity --//
                                                logActivity(_ACTIVITY_DELETE, _SUBSUBMATERIAL, ("حذف عنوان در بخش 4: " + txf_categories_title.text))

                                                listmodel.remove(clickedIndex, 1)

                                                //-- triger subcategory list --//
                                                if(lv.count>0)
                                                    returnSelectedSubSubMaterial(listmodel.get(clickedIndex).id)
                                                else returnSelectedSubSubMaterial("empty")
                    ...
                    ColumnLayout{
                        ...
                        Rectangle{
                            ...
                            Label{
                                ...
                                /*text: ""
                                      + (isIdShow           ? txf_categories_categoryID.text            : "")
                                      + (isMaterialCategoryShow ? "  " + txf_categories_subMaterial.text   : "")
                                      + (isTitleShow        ? "  " + txf_categories_title.text          : "")
                                      + (isPicShow          ? "  " + txf_categories_pic.text            : "")
                                      + (isDateShow         ? "  " + txf_categories_date.text           : "")*/
                                rotation: 90
    ...
    function fetchBasedonSubSubMaterial(categoryID){
        ...
        //-- search based on categoryID --//
        var endpoint = "api/kootwall/SubSubMaterial?c=" + categoryID
...
//                                            returnSelectedBaseCategory("empty")
    ...
    function clearCategoriesTextfields(){
        ...
        if(isSubMaterialShow    && txf_categories_subMaterial.enabled)     txf_categories_subMaterial.text    = ""
    }
