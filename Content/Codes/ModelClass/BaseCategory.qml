...
Rectangle{
    ...
    property string pageTitle:              "فصول اصلی" //-- modul header title --//
                    ...
                    MButton{
                        ...
                        onClicked: {
                            ...
                            if(txf_categories_category.text === ""){
                                ...
                                triggerMsg("در شاخه دسته بندی آیتمی انتخاب نشده است", "RED")
                                return
                            }
...
//                                "pic"       : txf_categories_pic.text,
                            ...
                            checkToken(function(resp){
                                ...
                                Service.create_item(_token_access, endpoint, data, function(resp, http) {
                                    ...
                                    //-- log activity --//
                                    logActivity(_ACTIVITY_CREATE, _BASECATEGORY, ("عنوانی جدید در فصول اصلی ایجاد شد: " + txf_categories_title.text))
...
//                                    "pic"       : txf_categories_pic.text
                                ...
                                checkToken(function(resp){
                                    ...
                                    Service.update_item(_token_access, endpoint, data, function(resp, http) {
                                        ...
                                        //-- log activity --//
                                        logActivity(_ACTIVITY_UPDATE, _BASECATEGORY, ("به روز رسانی عنوان در فصول اصلی: " + txf_categories_title.text))
                                    ...
                                    Service.delete_item(_token_access, endpoint, function(resp, http) {
                                        ...
                                        if(resp.hasOwnProperty('del')) // chack exist detail in resp
                                        {
                                            if(resp.del.indexOf("successfull delete operation") > -1){
                                                ...
                                                //-- log activity --//
                                                logActivity(_ACTIVITY_DELETE, _BASECATEGORY, ("حذف عنوان در فصول اصلی: " + txf_categories_title.text))
